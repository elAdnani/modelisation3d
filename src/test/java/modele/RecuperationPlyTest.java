...
public class RecuperationPlyTest {
	...
	/**
	 * Cette méthode est utile pour nos testes de temps. Comme il n'y a pas d'autres classes qui calcule le temps, elle est placée ici.<br>
	 * 
...
/*			repetition=10000;
			...
			for (int i = 0; i < repetition; i++)
				{
				matrice=null;
				matrice = RecuperationPly.recuperationMatrice(myPath+"vache.ply");

				}
			endTime = System.nanoTime();
			
			assertTrue( nanotimeToMiliseconds(repetition, (float) (endTime - startTime))<1.6);
